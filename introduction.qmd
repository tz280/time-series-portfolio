...
Our analysis is organized around ten core questions that bridge technical findings to household realities:

## Monetary Policy & Intervention Effects

1. **Can aggressive interest rate hikes reverse food price increases that already occurred?**  
   *Explores the fundamental asymmetry between preventing new inflation vs. undoing past price level changes*

2. **How long does it take for Fed rate changes to affect different parts of the economy?**  
   *Contrasts immediate financial market responses with lagged food price transmission and persistent effects*

## Food Price Behavior & Household Budgets

3. **Why don't food prices fall back down when overall inflation "cools"?**  
   *Investigates the ratchet effect, autocorrelation patterns, and supply-side vs demand-side drivers*

4. **Can families escape rising grocery costs by eating at restaurants more (or vice versa)?**  
   *Tests substitution hypothesis using VAR causality analysis and differential inflation rates*

5. **Which specific foods drive overall grocery inflation—and can tracking them provide early warning?**  
   *Examines ARIMAX coefficient magnitudes (milk β=6.99) and Granger causality for leading indicators*

## Financial Markets & Wealth Effects

6. **Do inflation-protected investments actually protect during high inflation periods?**  
   *Reveals the TIPS volatility paradox through GARCH persistence parameters*

7. **How long does financial market instability last after each inflation shock?**  
   *Calculates half-lives and persistence from GARCH models to quantify sustained uncertainty*

## Integration & Compound Effects

8. **When do the three burdens hit simultaneously vs. sequentially?**  
   *Analyzes temporal overlap using lag structures from all three model families*

9. **Is the 2022 inflation experience a temporary crisis or a permanent shift to a "new normal"?**  
   *Combines trend decomposition, structural break tests, and 12-month forecasts*

10. **What does "successful" inflation control look like from a household perspective vs. a central bank perspective?**  
    *Contrasts CPI headline success (9.1%→3%) with persistent household burdens (40% food baseline, 18-day volatility)*
